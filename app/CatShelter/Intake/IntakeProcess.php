...
class IntakeProcess implements AggregateRoot
{
    ...
    public function assignCatToKennel(AssignCatToKennel $command)
    {
        $this->recordThat(new CatWasAssignedToKennel(
            $command->kennel()
        ));
    }

    protected function applyCatWasAssignedToKennel(CatWasAssignedToKennel $event)
    {
        //
    }
