...
final class CatWasAssignedToKennel implements SerializableEvent
{
    /**
     * @var string
     */
    ...
    public function kennel(): string
    {
        return $this->kennel;
    }
    public static function fromPayload(array $payload): SerializableEvent
    {
        return new CatWasAssignedToKennel(
            (string) $payload['kennel']);
    }

    public function toPayload(): array
    {
        return [
            'kennel' => (string) $this->kennel,
        ];
    }
     ...
     * @codeCoverageIgnore
     */
    public static function withKennel(string $kennel): CatWasAssignedToKennel
    {
        return new CatWasAssignedToKennel(
            $kennel
        );
